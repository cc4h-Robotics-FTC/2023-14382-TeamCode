...
public class DriveConstants {
    ...
    public static double TRACK_WIDTH = 15.63; // in
    ...
    public static double MAX_ANG_VEL = Math.toRadians(143.05000665588634);
    public static double MAX_ANG_ACCEL = Math.toRadians(143.05000665588634);
